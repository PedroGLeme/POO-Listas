...
int main()
{
    int* numeros = new int[500001]; // lista de numeros inseridos, caso numero ja existe, nao insere
    int* verdadeiro = new int[500001]; // variavel indica se foram ou nao removidos os numeros pelo resto da divisao por 2
